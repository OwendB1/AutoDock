...
internal static class AutoDockConstants
{
    ...
    public const double AutoDockLinearProportionalGain = 0.75;
    ...
    public const double AutoDockMaxLinearAcceleration = 2.5;
    public const double AutoDockFinalApproachDistance = 2.75;
    public const double AutoDockFinalApproachOrientationThreshold = 0.35;
    public const double AutoDockFinalPlanarProportionalBoost = 1.8;
    public const double AutoDockFinalPlanarIntegralBoost = 0.75;
    public const double AutoDockFinalPlanarDerivativeBoost = 1.15;
    public const double AutoDockFinalPlanarHoldDistance = 0.35;
    public const double AutoDockFinalAxialSuppression = 0.75;
    ...
    public const double AutoDockMaxAngularVelocity = 0.45;
